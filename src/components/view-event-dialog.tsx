                                                ...
                                                onSelect={(date) => {
                                                    if (date) {
                                                        const newStart =
                                                            new Date(date)
                                                        newStart.setHours(
                                                            editedEvent.startDateTime.getHours(),
                                                            editedEvent.startDateTime.getMinutes()
                                                        )
                                                        const newEnd = new Date(
                                                            date
                                                        )
                                                        newEnd.setHours(
                                                            editedEvent.endDateTime.getHours(),
                                                            editedEvent.endDateTime.getMinutes()
                                                        )
                                                        setEditedEvent({
                                                            ...editedEvent,
                                                            startDateTime:
                            ...
                            <div className="grid gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <div className="flex items-center gap-2 text-sm">
                                        ...
                                        {format(event.startDateTime, 'PPPP')}
                                    </div>
                                </div>
